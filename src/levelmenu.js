const levelmenu = (prefix, namebot) => {
	return `
*Regras para adcionar o ${namebot} em seu Bonde*\n
 ...
 ◆➤ 🔰 2 Entre na  central e mande o link no pv do ${namebot} 

 ◆➤ 🔰 3 DEVERÁ ESTÁ É PERMANECE NO GRUPO DE CONTROLE (Digite ${prefix}gpof )

 ◆➤ 🔰 4 *O GRUPO A QUAL E PRETENDIDO ADICIONAR O ${namebot} DEVE ESTAR COM MAIS DE 10 PARTICIPANTES* 
